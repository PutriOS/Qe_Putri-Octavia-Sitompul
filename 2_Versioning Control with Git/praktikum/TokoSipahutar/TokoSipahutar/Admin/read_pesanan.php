...
$perintah = "SELECT pesanan.*,tb.nama_barang,tp.alamat,tp.nama FROM pesanan JOIN barang tb ON pesanan.id_barang = tb.id_barang join pembeli tp on pesanan.id_pembeli = tp.id_pembeli ORDER BY pesanan.status,tp.nama";
